...
export function Footer() {
  return (
    <footer style={s('border-top:1px solid #DFE3EA; background:rgba(255,255,255,0.62); backdrop-filter:blur(16px); padding:80px 0 36px; color:#5A616D')}>
      <div style={s('max-width:1400px; margin:0 auto; padding:0 40px; display:grid; grid-template-columns:repeat(12, 1fr); gap:20px')}>
        <div style={s('grid-column:1 / span 4')}>
      ...
      <div style={s('max-width:1400px; margin:52px auto 0; padding:24px 40px 0; border-top:1px solid #DFE3EA; display:flex; justify-content:space-between; font-size:13px')}>
