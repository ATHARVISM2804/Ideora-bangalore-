  ...
  return (
    <section id="about" style={s('padding:0 0 clamp(80px, 12vw, 170px)')}>
      <div className="om-g12" style={s('max-width:1400px; margin:0 auto; padding:0 clamp(20px, 5vw, 40px); display:grid; grid-template-columns:repeat(12, 1fr); gap:20px; align-items:start')}>
        ...
        <div data-anim="card" style={s('grid-column:9 / span 4; border-radius:18px; overflow:hidden; border:1px solid var(--rule); box-shadow:0 26px 58px -38px rgba(28,25,23,0.55); animation:om-float 8s ease-in-out infinite; height:340px; position:relative')}>
          <CredibilityDiagram />
        </div>
      </div>
    </section>
