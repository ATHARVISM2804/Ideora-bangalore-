      ...
      <div style={s('max-width:1400px; margin:0 auto; padding:0 clamp(20px, 5vw, 40px)')}>
        <div onMouseMove={spot} style={s('position:relative; overflow:hidden; border-radius:24px; background:#F4601E; color:#FFFFFF; padding:76px 56px; box-shadow:0 50px 100px -50px rgba(244,96,30,0.7)')}>
          ...
          <div className="om-g12" style={s('position:relative; display:grid; grid-template-columns:repeat(12, 1fr); gap:20px')}>
            <h2 data-anim="head" style={s('grid-column:1 / span 6; margin:0; font-family:Archivo, sans-serif; font-stretch:125%; font-weight:500; font-size:clamp(28px, 5.2vw, 44px); line-height:0.94; letter-spacing:-0.035em')}>Bring us the process nobody wants to own.</h2>
