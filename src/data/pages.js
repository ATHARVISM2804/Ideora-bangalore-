...
export const PAGES = [
  {
    ...
    inputs: [
      'Events from forms, WhatsApp, voice, email and integrations',
      'The rule, agent or workflow step that acted',
      'Exception owner, reason and SLA',
      'Timestamps, sources and results for every write',
      'Your organisation and location structure, for access',
    ],
    deployment: [
      {
        title: 'Discovery',
        body: 'We map the process as it runs today, the exception rules nobody wrote down, and what success is measured in. You keep the map.',
      },
      {
        title: 'Configuration',
        body: 'The console is configured to your sites, roles and service-level targets, and to the thresholds that decide when a forecast is confident enough to show at all.',
      },
      {
        title: 'Integration',
        body: 'Connected to the systems named above, with your permissions and escalation rules, then run against real volume before anything cuts over.',
      },
      {
        title: 'User acceptance',
        body: 'Your managers work the console against real queues until the numbers reconcile with what they already count by hand. If the two disagree, we fix it before launch rather than explaining it after.',
      },
      {
        title: 'Training',
        body: 'Your supervisors are trained on the exception queue and your managers on the weekly report. There is no data entry to learn: the console reads what the workflows already write.',
      },
      {
        title: 'Support',
        body: 'We monitor queues, exceptions, accuracy and cost, and keep improving the process while it runs. One named owner on our side, one on yours.',
      },
    ],
    evidence: {
      baseline: 'Backlog, ageing and exceptions were visible at month end, from a reporting pipeline separate from the systems the work happened in.',
      workflow: 'Every action an automated workflow takes writes an audit record. The console reads those records directly, so the management view and the operation cannot disagree.',
      outcome: 'Queue, backlog and exception ageing visible the day they happen, from the same records the work was done in.',
      source: 'Described from the system scope and records at a cross-vertical deployment, live since June 2026.',
      caseStudy: null,
    },
  ...
  },
  {
    ...
    inputs: [
      ...
      'Purchase timeline',
      'Funding readiness',
      'Consent state, captured at source',
    ],
    deployment: [
      {
        title: 'Discovery',
      ...
      {
        title: 'Configuration',
        body: 'The product is configured to your projects, inventory, routing rules and what counts as a premium lead. This is where you decide what the system may answer and what goes straight to an agent.',
      },
      {
        title: 'Integration',
        body: 'Connected to the systems named above, with your permissions and escalation rules, then run against real volume before anything cuts over.',
      ...
      {
        title: 'User acceptance',
        body: 'Your sales team works the system against real leads, including a pricing question and a poor match, until the routing behaves the way the design said it would.',
      },
      {
        title: 'Training',
        body: 'Your agents are trained on the qualified-lead view and the follow-up queue. Leads still land in the CRM they already work.',
      },
      {
        title: 'Support',
        body: 'We monitor queues, exceptions, accuracy and cost, and keep improving the process while it runs. One named owner on our side, one on yours.',
    ...
    evidence: {
      ...
      workflow: 'Leads from every source land in one intake and get a reply in seconds. The system qualifies budget, location, property type and timeline, matches against live inventory, and offers a viewing from the agent calendar.',
      ...
      source: 'Described from the system scope and records at a residential developer, live since April 2026. Conversion-rate change is being measured with the client and is not published until it is.',
      caseStudy: '/case-studies/property-lead-qualification',
    },
    transcript: {
      intro: 'This is what qualification looks like from the lead\'s side. It is a demonstration conversation, written to the same rules the live system follows, so it can be shown without redacting a real buyer.',
      lines: [
        {
          from: 'them',
          text: 'Saw the 3BHK listing on the portal. Is it still available?',
        },
        {
          from: 'system',
          text: 'It is. Before I book you in, two quick things so I show you the right unit: what budget are you working to, and which areas are you looking at?',
        },
        {
          from: 'them',
          text: 'Around 1.4 crore. Whitefield or Sarjapur.',
        },
        {
          from: 'system',
          text: 'That works. Are you looking to move in the next three months, or is this a longer search? And is the funding arranged, or would a loan be involved?',
        },
        {
          from: 'them',
          text: 'Next 2-3 months. Loan, pre-approved already.',
        },
        {
          from: 'system',
          text: 'Two projects match that in Whitefield. Both have 3BHK units in your range with possession inside your timeline. I can hold a site visit this Saturday at 11:00 or Sunday at 16:00 with Priya, who covers Whitefield.',
        },
        {
          from: 'them',
          text: 'Saturday 11 works. One thing though, is the quoted price negotiable?',
        },
        {
          from: 'human',
          text: 'Priya here. I handle pricing on this project personally, so let me answer that on the call rather than over message. Your Saturday 11:00 visit is confirmed and I have your requirement in front of me.',
        },
      ],
      note: 'Demonstration conversation on synthetic data. Where we show a real lead journey in a call, personally identifiable information is removed first and the client has approved it. Note the last turn: pricing is one of the questions the system is not allowed to answer.',
    },
  ...
  },
  {
    ...
    inputs: [
      ...
      'The appointment request, in the patient\'s own words',
      'Department and doctor',
      'Location or clinic',
      'Consent state, captured at source',
      'Referral source where there is one',
    ],
    deployment: [
      {
        title: 'Discovery',
      ...
      {
        title: 'Configuration',
        body: 'The product is configured to your departments, doctors, locations and booking rules. This is the step that decides what the system may answer on its own and what it must route to the desk.',
      },
      {
        title: 'Integration',
        body: 'Connected to the systems named above, with your permissions and escalation rules, then run against real volume before anything cuts over.',
      ...
      {
        title: 'User acceptance',
        body: 'Your front-desk team works the system against real enquiries until it behaves the way the design said it would. Nothing goes live on a date; it goes live when your team signs it off.',
      },
      {
        title: 'Training',
        body: 'Your desk staff and whoever owns the exception queue are trained on the queue and the management view. It is a short session because there is no new system to learn -- the bookings land where they always did.',
      },
      {
        title: 'Support',
        body: 'We monitor queues, exceptions, accuracy and cost, and keep improving the process while it runs. One named owner on our side, one on yours.',
    ...
    evidence: {
      ...
      workflow: 'The system answers the enquiry, matches department and doctor, writes the appointment into the operational calendar, and collects registration details and consent ahead of arrival.',
      ...
      source: 'Described from the system scope and records at a multi-location clinic group, live since May 2026. Wait-time change is being measured with the client and is not published until it is.',
      caseStudy: '/case-studies/clinic-intake-and-coverage',
    },
  ...
  },
  {
    ...
    inputs: [
      ...
      'Vehicle: registration, model and service history',
      'The service concern, in the customer\'s own words',
      'Preferred location',
      'Time window',
      'Consent state, captured at source',
    ],
    deployment: [
      ...
      {
        title: 'Configuration',
        body: 'The product is configured to your bays, advisors, service categories and capacity rules, and to the approval thresholds that decide what an estimate may commit without a person.',
      },
      {
        title: 'Integration',
        body: 'Connected to the systems named above, with your permissions and escalation rules, then run against real volume before anything cuts over.',
      ...
      {
        title: 'User acceptance',
        body: 'Your advisors work the system against real jobs, including a disputed estimate and a safety finding, until the escalation behaves the way the design said it would.',
      },
      {
        title: 'Training',
        body: 'Your advisors and the person who owns the exception queue are trained on the queue, the capacity view and the approval flow. The job cards still land in the DMS they already use.',
      },
      {
        title: 'Support',
        body: 'We monitor queues, exceptions, accuracy and cost, and keep improving the process while it runs. One named owner on our side, one on yours.',
    ...
    evidence: {
      ...
      workflow: 'The system takes the enquiry, identifies the vehicle and the concern, checks genuine bay and advisor availability, holds the slot and returns a confirmation. Estimates go out for written approval against the job.',
      ...
      source: 'Median time from enquiry to confirmed slot, measured from system records at a multi-site service group since go-live in February 2026.',
      caseStudy: '/case-studies/service-centre-bookings',
    },
    product: 'Ideora Auto',
    industry: 'automotive',
