...
export const DASHBOARDS = [
  {
    ...
    queue: [
      { name: 'Andheri', n: '18 open', pct: '72%' },
      { name: 'Pune', n: '11 open', pct: '44%' },
      { name: 'Nashik', n: '5 open', pct: '20%' },
    ],
...

  {
    ...
    queue: [
      { name: 'Kothrud', n: '11 open', pct: '58%' },
      { name: 'Baner', n: '7 open', pct: '34%' },
      { name: 'Wakad', n: '4 open', pct: '19%' },
    ],
