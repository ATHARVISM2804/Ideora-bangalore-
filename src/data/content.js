...
export const CASES = [
  ...
  { vertical: "Cross-vertical", code: "sys_04", status: "live",
    ...
    image: { name: "case-operations" }, place: "bottom",
  ...
  { vertical: "Finance", code: "sys_05", status: "in build",
    ...
    to: null, cta: null,
    image: { name: "case-finance", position: "center 30%" }, place: "bottom",
